# Small kids game. Match text and images to start to learn reading by word-image association. The game is more or less completely written by Cursor, so if the code looks messy, don't blame me.
